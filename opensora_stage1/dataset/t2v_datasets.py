...
from opensora_stage1.utils.utils import text_preprocessing
...
class T2V_dataset(Dataset):
    ...
    def get_video(self, idx):
        ...
        video_path = self.vid_cap_list[idx]['path']
        trajectory_anno_path = self.vid_cap_list[idx]['dense_pose_path']
        ...
        # frame_idx = self.vid_cap_list[idx]['frame_idx']
        frame_idx = None
        video, trajectory_anno = self.decord_read(video_path, trajectory_anno_path, frame_idx)
    ...
    def decord_read(self, path, trajectory_anno_path, frame_idx=None):
        ...
        assert total_frames == total_frames_trajectory

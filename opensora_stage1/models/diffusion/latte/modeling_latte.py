...
from opensora_stage1.models.diffusion.utils.pos_embed import get_1d_sincos_pos_embed, PositionGetter1D, PositionGetter2D
from opensora_stage1.models.diffusion.latte.modules import PatchEmbed, BasicTransformerBlock, BasicTransformerBlock_, AdaLayerNormSingle, \
...
class LatteT2V(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        interaction_condition = self.interaction_encoder(cond_trajectory)
...
if __name__ == '__main__':
    from opensora_stage1.models.ae import ae_channel_config, ae_stride_config

...
from opensora_stage1.models.diffusion.utils.pos_embed import get_2d_sincos_pos_embed, RoPE1D, RoPE2D, LinearScalingRoPE2D, LinearScalingRoPE1D
...
class InteractionEncoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = nn.Conv2d(4, 1152, kernel_size=2, stride=2, padding=0)
    ...
    def forward(
            self,
            trajectory: torch.Tensor, # shape: (B, T, H, W, C)
    ):
        ...
        motion_patches = self.conv(trajectory.view(b*t, c, h, w))

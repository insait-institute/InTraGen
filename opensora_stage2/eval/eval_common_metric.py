...
import sys
sys.path.append(".")
from opensora_stage2.eval.cal_lpips import calculate_lpips
from opensora_stage2.eval.cal_fvd import calculate_fvd
from opensora_stage2.eval.cal_psnr import calculate_psnr
from opensora_stage2.eval.cal_flolpips import calculate_flolpips
from opensora_stage2.eval.cal_ssim import calculate_ssim

...
from opensora_stage2.models.causalvideovae import ae_stride_config
...
from opensora_stage2.models.text_encoder import get_text_enc
from opensora_stage2.utils.utils import save_video_grid
...
def main(args):
    ...
    vae = CausalVAEModelWrapper(args.ae, cache_dir=args.cache_dir).eval().to(device, dtype=torch.float16)
